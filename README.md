...
- BTST CMS and visual UI Builder
- PostgreSQL 18
- Redis 8
...
CMS migrations, builds the BTST admin, and starts both Node services. Later starts
skip installation and rebuilding unless their inputs changed.
